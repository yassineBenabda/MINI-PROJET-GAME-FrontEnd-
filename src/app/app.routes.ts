...
export const routes: Routes = [
  ...
  { path: 'games', component: GamesComponent, canActivate: [canActivateAuthRole], data: { role: ['ADMIN', 'USER'] } },
  ...
  { path: 'addGames', component: AddGamesComponent, canActivate: [canActivateAuthRole], data: { role: 'ADMIN' } },
  { path: 'addPlatform', component: AddPlatformComponent, canActivate: [canActivateAuthRole], data: { role: 'ADMIN' } },
  { path: 'addDeveloper', component: AddDeveloperComponent, canActivate: [canActivateAuthRole], data: { role: 'ADMIN' } },
  { path: 'updateGame/:id', component: UpdateGameComponent, canActivate: [canActivateAuthRole], data: { role: 'ADMIN' } },
  { path: 'updateDeveloper/:id', component: UpdateDeveloperComponent, canActivate: [canActivateAuthRole], data: { role: 'ADMIN' } },
  { path: 'updatePlatform/:id', component: UpdatePlatformComponent, canActivate: [canActivateAuthRole], data: { role: 'ADMIN' } },
